...
trait HMWDG_backupRestore
{
    ...
    public function CreateBackup()
    {
        if (IPS_GetInstance($this->InstanceID)['InstanceStatus'] == 102) {
            $name = $this->Translate('Configuration') . ' (' . IPS_GetName($this->InstanceID). ' #'.$this->InstanceID . ') ' . date('d.m.Y H:i:s');
            ...
            echo $this->Translate('The configuration was successfully saved!');
        }
    }
    ...
    public function RestoreConfiguration()
    {
        ...
        if ($backupScript != 0 && IPS_ObjectExists($backupScript)) {
            ...
            echo $this->Translate('The configuration was successfully restored!');
        }
    }
}
